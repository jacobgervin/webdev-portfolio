...
<div id="work" className="md:h-screen h-fit w-screen workbackground">
  <div className="max-w-screen-xl p-8 mx-auto flex flex-col">
    ...
    <div className="absolute workbox z-10"></div>
        <div className="z-20 relative">
            <h1 className=" font-extrabold tracking-widest text-3xl mt-20 ml-2 worktitle">WORK</h1>
        </div>

    </div>
    <div  className="flex flex-col md:flex-row items-center md:space-x-4 space-y-4 md:space-y-0 mt-10 ">

        <div className="h-96 w-96 bg-neutral-700 relative overflow-hidden">
        <Link to="/workpage/1">
            <img src={cocktailshopImg} className="object-cover w-full h-full"/>
            <h3 className="absolute font-thin left-4 bottom-4">COCKTAIL WEBSHOP</h3>
        </Link>
            <a className="absolute right-4 bottom-4 flex flex-row items-center cursor-pointer">
