...
{projects.map((project, index) => (
        ...
        className="bg-neutral-700 relative overflow-hidden cursor-pointer hover:font-bold mb-8 group ">
        <Link to={`/workpage/${project.id}`}>
            ...
            <h3 className="absolute font-medium left-4 bottom-4">{project.name}</h3>
        </Link>
