...
transition={{ duration: 0.25 }}
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">WORK</motion.Link></li>
      <li>
                <motion.Link 
                animate={!showNav ? "open" : "closed"}
                variants={workvariant}
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">ABOUT</motion.Link>
      </li>
      <li>
      <motion.Link 
                      animate={!showNav ? "open" : "closed"}
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">CONTACT</motion.Link>
      </li>
      <li>
      <motion.div
                animate={!showNav ? "open" : "closed"}
