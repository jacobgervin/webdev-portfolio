...
<nav class="fixed w-full z-30 top-0 left-0 navbar ">
  ...
  class="flex items-center navlink w-fit">
      <span class="self-center text-md font-extralight whitespace-nowrap tracking-widest navbarbrand cursor-pointer">JACOB GERVIN</span>
  </Link>
  </div>
  <div class="flex md:order-2 justify-end w-40">
    <a href="https://github.com/jacobgervin" className="flex flex-row items-center cursor-pointer hidden md:block" target="_blank" rel="noopener noreferrer">
    ...
    <a href="https://www.linkedin.com/in/jacob-gervin-25457b212/" className="flex flex-row items-center cursor-pointer hidden md:block" target="_blank" rel="noopener noreferrer">
    <svg xmlns="http://www.w3.org/2000/svg" fill="#262626" className="w-6 h-6" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
    </a>
   ...
   class={`flex flex-col justify-center block md:hidden w-screen h-[88vh] ${showNav && 'hidden'}`}>
    ...
    className='h-96 flex flex-col justify-evenly mb-10'>
      <li>        
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">WORK</Link></li>
      <li>
                <Link 
          to="about"
          smooth={true}
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">ABOUT</Link>
      </li>
      <li>
      <Link 
          to="contact"
        ...
        class="block py-2 pr-4 text-6xl rounded md:bg-transparent md:p-0 navlink cursor-pointer">CONTACT</Link>
      </li>
      <li>
      <div class="flex md:order-2 space-x-3 justify-start w-full py-2 pr-4">
  ...
  <div class={`items-center justify-between hidden w-full md:flex md:w-auto md:order-1 `}>
    <ul class="flex flex-col p-4 md:p-0 mt-4 font-extralight tracking-widest md:flex-row md:space-x-[100px] md:mt-0 navbarlinks">
      <li>
        <Link 
          to="work"
          smooth={true}
        ...
        class="block py-2 pl-3 pr-4 rounded md:bg-transparent md:p-0 navlink cursor-pointer">WORK</Link>
      </li>
      <li>
        <Link 
          to="about"
        ...
        class="block py-2 pl-3 pr-4 rounded md:bg-transparent md:p-0 navlink cursor-pointer">ABOUT</Link>
      </li>
      <li>
        <Link 
          to="contact"
        ...
        class="block py-2 pl-3 pr-4 rounded md:bg-transparent md:p-0 navlink cursor-pointer">CONTACT</Link>
      </li>
    </ul>
  </div>
  </div>
